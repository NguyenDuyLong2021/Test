       ...
       <div class="register_account">
    	      ...
    	      <h4 class="title">Create an Account</h4>
				<%
					if(error!=null) {
				%>
                <h4 style="color: red" class="title">Create an Account</h4>
                <%}%>
    		   <form action="/lab6/Register" method="post">
    			 <div class="col_1_of_2 span_1_of_2">
		   			 <div><input type="text" value="Name" name="name_user" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Name';}"></div>
		    			<div><input type="text" value="Full name" name="fullname" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Company Name';}"></div>
		    			<div><input type="text" value="Age" name="age" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'E-Mail';}"></div>
